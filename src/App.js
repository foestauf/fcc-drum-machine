...
class App extends React.Component {
  ...
  adjustVolume(e) {
    if (this.state.power) {
      this.setState({
        sliverVal: e.target.value,
        display: "Volume: " + Math.round(e.target.value * 1000)
      });
    }
  }
  clearDisplay() {
    ...
    return (
      ...
      <div className="controls-container">
        ...
        <div className="volume-slider">
          <input type="range" min="0" step="0.01" value={this.state.sliverVal} onChange={this.adjustVolume} />
        </div>
